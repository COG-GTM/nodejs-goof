...
process.env.CHAT_USER_NAME = 'user';
process.env.CHAT_USER_PASSWORD = 'test-password';
...
const AUTH = { name: process.env.CHAT_USER_NAME, password: process.env.CHAT_USER_PASSWORD };
